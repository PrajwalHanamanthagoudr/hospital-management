...
public class PersonController {
	...
	public ResponseStructure<Person> updatePersonById(@PathVariable int id,Person person){
		return personService.updatePersonById(id, person);
	}
	
	@DeleteMapping("/persons{id}")
	public ResponseStructure<Person> deletePersonById(@PathVariable int id){
